  ...
  function ReactGridLayout() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function (i, w, h, _ref5) {
      ...
      if (["sw", "w", "nw", "n", "ne"].indexOf(handle) !== -1) {
        ...
        l.w = w;
        l.h = h; // Move the element to the new position.

        var isUserAction = true;
        finalLayout = (0, _utils.moveElement)(newLayout, l, _x, _y, isUserAction, _this.props.preventCollision, (0, _utils.compactType)(_this.props), cols, allowOverlap);
      } else {
        l.w = w;
        l.h = h;
      ...
      _this.props.onResize(finalLayout, oldResizeItem, l, placeholder, e, node); // Re-compact the newLayout and set the drag placeholder.
  ...
  _createClass(ReactGridLayout, [{
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      return /*#__PURE__*/React.createElement(_GridItem.default, {
        ...
        y: activeDrag.y,
        i: activeDrag.i,
        className: (0, _classnames.default)("react-grid-placeholder", {
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var _this$state2 = this.state,
          ...
          droppingPosition = _this$state2.droppingPosition; // Determine user manipulations possible.
